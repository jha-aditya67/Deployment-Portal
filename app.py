...
# Basic HTML layout for your Amity University project dashboard
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        .status-badge { inline-block; padding: 6px 12px; background-color: #28a745; color: white; border-radius: 20px; font-size: 14px; font-weight: bold; }
...
@app.route('/')
def home():
    print("Dashboard requested by a visitor!", flush=True) # This will print directly to your AWS Logs!
    return render_template_string(HT# app.py
from flask import Flask, render_template_string
import sys
...
if __name__ == '__main__':
    ...
    # AWS Fargate routes internal container traffic on port 80
    app.run(host='0.0.0.0', port=80)ML_TEMPLATE)
